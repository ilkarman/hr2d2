...
from cv_lib.azureml_tools import workspace_for_user
from cv_lib.azureml_tools.config import experiment_config
from cv_lib.azureml_tools.resource_group import create_resource_group
from cv_lib.azureml_tools.storage import create_premium_storage
from cv_lib.azureml_tools.subscription import select_subscription

_GPU_IMAGE = "mcr.microsoft.com/azureml/base-gpu:openmpi3.1.2-cuda10.0-cudnn7-ubuntu16.04"
_VIENNA_IMAGE = "viennaprivate.azurecr.io/pytorch:1.3-gpu"
...
def _create_estimator(
    ...
    # Enable for SRIOV
    estimator.run_config.environment.environment_variables = {
            "NCCL_IB_DISABLE": "0",
