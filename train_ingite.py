...
def run(local_process_id, node_rank, dist_url, run_config):
    ...
    train_loader = data.DataLoader(
        train_set, batch_size=run_config.TRAIN.BATCH_SIZE_PER_GPU, num_workers=4, sampler=train_sampler,
    )
    ...
    val_loader = data.DataLoader(
        val_set, batch_size=run_config.TRAIN.BATCH_SIZE_PER_GPU, num_workers=4, sampler=val_sampler,
    )
